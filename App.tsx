...
import CertificateVerificationPage from '@/src/apps/public/pages/CertificateVerificationPage';
...
const AppContent: React.FC<{ user: User | null; onLogin: (user: User) => void }> = ({ user, onLogin }) => {
  ...
  return (
    <Routes>
      ...
      <Route path="/verify-certificate" element={<PublicLayout><CertificateVerificationPage /></PublicLayout>} />
