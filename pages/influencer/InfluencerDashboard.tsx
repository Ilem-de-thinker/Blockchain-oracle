...
import { GraduationCap, CalendarDays, Copy, ArrowRight, ChartLine, User2, Bell, Settings, Filter, RefreshCcw, Users, X, Gift, DollarSign, BarChart3 } from 'lucide-react';
...
const InfluencerDashboard: React.FC<InfluencerDashboardProps> = ({ user }) => {
  ...
  return (
    <motion.div {...fadeIn} className="min-h-screen bg-bg text-text">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button asChild size="sm" className="shadow-sm whitespace-nowrap px-3 text-xs sm:text-sm text-white!">
                  <Link to="/courses/catalog">
                    <GraduationCap className="w-4 h-4 mr-2" />
                    Browse Courses
                  </Link>
                </Button>
                <Button variant="outline" asChild size="sm" className="bg-surface/50 whitespace-nowrap px-3 text-xs sm:text-sm">
                  <Link to="/events">
            ...
            <CardContent>
              {loading ? (
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl border border-primary/30 bg-primary/10 p-4 sm:p-6 text-center">
                    ...
                    <div className="grid gap-3">
                      <div className="rounded-2xl border border-border bg-surface p-4 flex flex-row items-center justify-between">
                        <div>
                      ...
                      <div className="rounded-2xl border border-primary/20 bg-primary/5 p-4 flex flex-row items-center justify-between">
                ...
                <div className="flex flex-col items-center gap-3 rounded-2xl border border-border bg-surface p-8 text-center">
                  <Gift className="h-10 w-10 text-text-muted/40" />
                  <div>
                    <p className="text-sm font-medium text-text-muted">No referral code yet</p>
                    <p className="text-xs text-text-muted/60 mt-1">Contact support to get your unique referral code.</p>
                  </div>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              {loading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-2xl border border-warning/20 bg-warning/10 p-3 sm:p-4">
                    ...
                    <div className="rounded-2xl border border-success/20 bg-success/10 p-3 sm:p-4">
                ...
                <div className="flex flex-col items-center gap-3 rounded-2xl border border-border bg-surface p-6 text-center">
                  <DollarSign className="h-8 w-8 text-text-muted/40" />
                  <div>
                    <p className="text-sm font-medium text-text-muted">No earnings yet</p>
                    <p className="text-xs text-text-muted/60 mt-1">Start sharing your code to earn commissions.</p>
                  </div>
                </div>
              )}
            </CardContent>
                ...
                <div className="divide-y divide-border">
                  {filteredReferees.slice(0, 6).length > 0 ? (
                    ...
                    <div className="flex flex-col items-center gap-3 px-4 py-10 text-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-text-muted">No referees found</p>
                ...
                <div className="mt-4 space-y-2">
                  {dashboardData?.monthly_stats?.slice(-4).reverse().map((stat) => (
                    ...
                    <div className="flex flex-col items-center gap-2 py-6 text-center">
                      ...
                      <p className="text-sm text-text-muted">No monthly performance data yet</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        <Card className="mt-6">
          <CardContent className="p-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              <Button variant="outline" className="justify-between h-auto py-4 bg-surface/50 border-border/40 hover:bg-surface/80 group" asChild>
