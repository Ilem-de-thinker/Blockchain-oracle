...
const InfluencerAnalyticsPage: React.FC = () => {
  ...
  const StatCard = ({ title, value, subtitle, icon: Icon, colorClass }: {
    ...
    <div className="bg-surface/80 backdrop-blur-md border border-border/50 rounded-2xl p-3 shadow-sm">
  ...
  const renderOverview = () => (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="bg-surface/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-sm">
        ...
        <div className="bg-surface/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-sm">
          ...
          <CardContent className="space-y-2 pt-0">
            <div className="rounded-2xl bg-primary/10 border border-primary/30 p-2 sm:p-3 text-center">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="text-center p-1.5 sm:p-2 rounded-2xl bg-surface/80 backdrop-blur-md">
                  ...
                  <div key={referee.id} className="bg-surface border border-border p-4 rounded-2xl flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="text-[10px] text-text-muted block">{referee.email}</span>
                      </div>
                    </div>
                  <div className="text-right">
        ...
        <div className="bg-surface/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-sm">
          ...
          <CardContent>
            <div className="grid gap-3 grid-cols-2 md:grid-cols-3">
              <div className="p-3 rounded-2xl bg-surface-alt/50 border border-border/50">
  ...
  return (
    <motion.div {...fadeIn} className="space-y-6">
      ...
      {error && (
        <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-4 text-sm text-red-200">
      ...
      {loading ? (
        <div className="grid gap-4 md:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-surface/80 backdrop-blur-md border border-primary/20 rounded-2xl p-5 shadow-sm">
        ...
        <>
          ...
          <div className="sm:hidden mb-4">
            <select
              ...
              className="w-full bg-surface border border-border rounded-2xl px-4 py-3 text-sm font-bold text-text focus:outline-none focus:border-primary"
            >
