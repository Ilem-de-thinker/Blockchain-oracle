          ...
          <div className="space-y-3">
            {!analytics?.analytics || analytics.analytics.length === 0 ? (
              <div className="p-12 text-center text-text-muted">
                <p>No code history found. Generate your first code above!</p>
              </div>
            ) : (
          ...
          <section className="bg-surface rounded-3xl border border-border overflow-hidden">
            ...
            <div className="p-6">
              {codeTrends && codeTrends.codes && codeTrends.codes.length > 0 ? (
                ...
                <p className="text-center py-8 text-text-muted text-sm">No trend data available</p>
              )}
            </div>
          </section>
          ...
          <section className="bg-surface rounded-3xl border border-border overflow-hidden">
            ...
            <div className="p-6">
              {conversionFunnel && conversionFunnel.funnel ? (
                ...
                <p className="text-center py-8 text-text-muted text-sm">No funnel data available</p>
              )}
            </div>
          </section>
