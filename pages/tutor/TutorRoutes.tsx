...
const TestimonialSubmissionPage = lazy(() => import('../dashboard/pages/TestimonialSubmissionPage'));
      ...
      <SharedDashboardLayout user={user}>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="testimonial" element={<TestimonialSubmissionPage user={user} />} />
